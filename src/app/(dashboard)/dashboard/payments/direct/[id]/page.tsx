...
export default async function DirectCustomerLedgerPage({ params }: { params: Params }) {
  ...
  return (
    <LedgerView
      ...
      backHref="/dashboard/payments?tab=direct"
      newPaymentHref={`/dashboard/payments/new?customerType=direct&customerId=${id}`}
